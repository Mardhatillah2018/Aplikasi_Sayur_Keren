                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <form action="/admin-kategori/{{ $kategori->id }}" method="post" class="d-inline">
                            @method('DELETE')
                            @csrf
                            <button title="Hapus Data" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini? Semua produk yang terkait dengan kategori ini juga akan dihapus.')">
