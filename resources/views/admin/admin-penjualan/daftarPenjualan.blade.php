...
<div class="d-flex justify-content-between mb-3">
    <!-- Tombol cetak riwayat penjualan dengan icon -->
    <a href="/admin-penjualan/cetak" class="btn btn-success mb-3" style="background-color: #2a6ec8; border-color: #0B773D; white-space: nowrap;">
